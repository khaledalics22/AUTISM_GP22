...
export class UserController {
    ...
    async getMyRecognizing(@Request() req, @Body() data: {
        ...
        await this.userService.getScoreToUserRecognize(req.user._id, data);
    }
    ...
    async getMyDoing(@Request() req, @Body() data: {
        ...
        await this.userService.getScoreToUserDoing(req.user._id, data);
    }
    ...
    async getRecognizing(@Body() data: {
        ...
        await this.userService.getStatisticsRecognize(data);
    }
    ...
    async getDoing(@Body() data: {
        ...
        await this.userService.getStatisticsDoing(data);
    }
