...
export class UserService {
    ...
    async UpdateScoreToUserEyeContact(userId: String, updateData: {
        date: string,
        score: number
    }) {
        return await this.UserRepository.updateEyeContact(userId, updateData);
    }

    async getScoreToUserEyeContact(userId: String) {
        return await this.UserRepository.getStatisticsInEyeContact(userId);
    }

    async getAllUsersScoreInEyeContact() {
        return await this.UserRepository.getOfALLStatisticsInEyeContact();
    }
    ...
    async UpdateScoreToUserDO(userId, data: {
        ...
        return await this.UserRepository.updateScoreInDoing(userId, data)
    }
    ...
    async UpdateScoreToUserRecognize(userId, data: {
        ...
        return await this.UserRepository.updateScoreInRecognize(userId, data);
    }
